...
import 'intl_localizations_bn.dart';
...
abstract class AppLocalizations {
  ...
  /// No description provided for @homeScreenBodyText.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @selectAnswerError.
  ///
  /// In en, this message translates to:
  ...
  /// Message shown after completing quiz with score
  ///
  /// In en, this message translates to:
